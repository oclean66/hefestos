    ...
    <div id='wrap'>
      <div id="content">
        ...
        <tr>
         ...
         <td style="padding-left: 10px; font-size: 15px;color: brown">
          <input class="" id="" maxlength="160" name="direccion" style="width: 435px;" value="<?php  echo $nm['direccion'];?>">
...
<table style="width:100%; background-color:#C5E3FF";>             
  ...
  while($reg=  mysql_fetch_array($resulreg))
  {
    ...
    <tr id ="<?php  echo $reg[0]?>" >
      ...
      <td style="padding-left: 10px;"><?php  /* echo $reg[1]." ".$reg[2].' (Cod. '.$reg[0].')';*/ ?><input  id="itemn<?php  echo $i?>" name = "itemn<?php  echo $i?>" style="width: 480px;" value="<?php  echo $reg[1]." ".$reg[2].' (Cod. '.$reg[0].')'; ?>"></input></td>
