...
if ( isset($_GET['d']) && isset($_GET['g']) && $_GET['d']!="" && $_GET['g']!="") {
    $fecha1 = $_SESSION['week1'] = $_GET['d'];
    $fecha2 = $_SESSION['week2'] = $_GET['g'];
}else {
    ...
    <div id='fondo'>
        <div id='wrap'>
            <div id="content2">
                ...
                <input name="submit" value="Actualizar" type="submit" onClick="document.location.href='../asignacionesConexion.php?d='+document.getElementById('inputField').value+'&g='+document.getElementById('inputField2').value;" >


                <div class="form">

                    <article id="computadorConexion"><img src="images/loading3.gif" width="120" height="120" style="margin-left: 45%;"></article>
