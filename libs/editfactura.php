    ...
    while($reg=  mysql_fetch_array($resulreg))
    {
      ...
      <tr id ="<?php  echo $reg[0]?>" >
        ...
        <tr>
          ...
          <td colspan="3" style="text-align: right;border-left: 0px;padding-right: 10px; background-color: rgb(68, 68, 68);color:white; "> Sub-Total </td>
          <td colspan="2" style="padding-left: 10px; background-color: rgb(68, 68, 68);color:white;">
           <span id="sb">0</span>
         </tr> 
         <tr>

          <td colspan="3" style="text-align: right;border-left: 0px;padding-right: 10px; background-color: rgb(68, 68, 68);color:white; "> IVA 12% </td>
          <td colspan="2" style="padding-left: 10px; background-color: rgb(68, 68, 68);color:white;">
           <span id="iva">0</span>
         </tr> 
         <tr>

          <td colspan="3" style="text-align: right;border-left: 0px;padding-right: 10px; background-color: rgb(68, 68, 68);color:white; ">TOTAL </td>
          <td colspan="2" style="padding-left: 10px; background-color: rgb(68, 68, 68);color:white;">
            <span id="t">0</span>
