...
$colores = array("blue", "orange", "red", "green", "lightred", "pink", "purple", "brown", "lime", "teal", "magenta", "satgreen");
        ...
        <ul class="tiles">
            ...
            <li class="lime long">
                <a href="#">
                    ...
                    <span class="name">Agencia Activos</span>
                </a>
            </li>
        ...
        <div class="box box-color box-bordered">
            ...
            <div class="box-content">
                ...
                <ul class="stats">
                    ...
                    ?>
                        <li class=<?php echo $colores[$key]; ?> style="margin-top:5px">
                        ...
                        ?>
                            <li class=<?php echo $colores[array_rand($colores, 1)]; ?> style="margin-top:5px;">
                                ...
                                <div class="details">
                                    ...
                                    <span><?php echo $valueX['name']; ?></span>
                                </div>
