		...
		<div class="box box-bordered box-color print" >
			<div class="box-title" style="">
				<h3>
					...
					<i class="fa fa-th-list"></i>Agencia <?php echo $model->concatened . " | Grupo " . $model->gCCD->concatened; ?>
				</h3>
			</div>
		...
		<div class="page-header">   
			<div class="pull-right">
				<ul class="minitiles">
					...
					<li class="orange">
						<a href="<?php echo Yii::app()->createUrl('gcca/view', array('id' => $model->GCCA_Id, 'excel' => true)) ?>">
