...
//Variables para busqueda relacionada
    ...
    public function getUsername(){
        $user = "";
        $log = Pcue::model()->find("PCUE_IdModel=:idmodel", array(":idmodel" => $this->FCCO_Id));  //("PCUE_Action='INSERTAR' AND PCUE_Model='Transacciones' AND PCUE_IdModel=:idmodel",array(":idmodel"=>$this->FCCO_Id));
        if(isset($log))
