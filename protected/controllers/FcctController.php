...
class FcctController extends Controller
{
	/**
	 ...
	 * @return Fcct the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Fcct::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Fcct $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='fcct-form')
		{
