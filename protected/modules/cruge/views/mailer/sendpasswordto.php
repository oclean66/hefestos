...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<style type="text/css">
			...
			body{width:100% !important; margin:0;background-image: url("/siam/themes/abound/img/fondo.png");
						...
						<table border="0" cellpadding="0" cellspacing="0" width="600px" style="height:100%;">
							...
							<tr>
								<td align="left" valign="bottom" style="padding-left:20px; padding-bottom:20px">
									<h1>Bienvenido!</h1>
									<br />
									<div class="textdark">Estimado <?php Yii::app()->user->um->getFieldValue(Yii::app()->user->id,'nombre') ?>, este correo se le ha enviado porque se han hecho cambios en 
                                                                            su cuenta recientemente en nuestro sistema Siam, 
...
<!--									<h3>Por favor, Debe activar su cuenta:</h3>
