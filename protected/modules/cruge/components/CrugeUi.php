...
class CrugeUi extends CComponent {
    ...
    public function getAdminItems() {
        return array(
            array('label' => CrugeTranslator::t('admin', 'User Manager'),
                'url' => "#",
                //'visible'=>Yii::app()->user->checkAccess('action_ui_editprofile'),
                ...
                'items' => array(array(
                    ...
                    array(
                        ...
                        'visible' => Yii::app()->user->checkAccess('action_ui_usermanagementcreate')
                    ),
                    array(
            ...
            array('label' => CrugeTranslator::t('admin', 'Custom Fields'),
                'url' => "#",'visible'=>Yii::app()->user->isSuperAdmin?true:false,
                'linkOptions' => array('data-toggle' => 'dropdown'),
                'itemOptions' => array('class' => 'dropdown'),
                'items' => array(array(
                        'label' => CrugeTranslator::t('admin', 'List Profile Fields'),
                        'url' => $this->getFieldsAdminListUrl(),
                        'visible' => Yii::app()->user->checkAccess('action_ui_fieldsadminlist')
                    ),
                    array(
                        'label' => CrugeTranslator::t('admin', 'Create Profile Field'),
                        'url' => $this->getFieldsAdminCreateUrl(),
                        'visible' => Yii::app()->user->checkAccess('action_ui_fieldsadmincreate')
                    ))
            ),
            array('label' => CrugeTranslator::t('admin', 'Roles and Assignments'),
                ...
                'items' => array(array(
                        ...
                        'visible' => Yii::app()->user->checkAccess('action_ui_rbaclistroles')
                    ),
                    array(
                        'label' => CrugeTranslator::t('admin', 'Tasks'),
                        'url' => $this->getRbacListTasksUrl(),
                        'visible' => Yii::app()->user->checkAccess('action_ui_rbaclisttasks')
                    ),
                    array(
                        'label' => CrugeTranslator::t('admin', 'Operations'),
                        'url' => $this->getRbacListOpsUrl(),
                        'visible' => Yii::app()->user->checkAccess('action_ui_rbaclistops')
                    ),
                    array(
                        'label' => CrugeTranslator::t('admin', 'Assign Roles to Users'),
                        'url' => $this->getRbacUsersAssignmentsUrl(),
                        'visible' => Yii::app()->user->checkAccess('action_ui_rbacusersassignments')
                    ))
            ),
            array('label' => CrugeTranslator::t('admin', 'System'),
                ...
                'items' => array(
                    array(
                        ...
                        'visible' => Yii::app()->user->checkAccess('action_ui_sessionadmin')
                    ),
                    array(
                        'label' => CrugeTranslator::t('admin', 'System Variables'),
                        'url' => $this->getSystemUpdateUrl(),
                        'visible' => Yii::app()->user->checkAccess('action_ui_systemupdate')
                    )
                )),
        );
    }
    ...
    private function _button($label, $name = null) {
        ...
        $ar = array('name' => $name, 'class' => 'btn btn-primary');
