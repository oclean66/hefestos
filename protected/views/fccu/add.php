...
<div class="col-sm-12">
    <div class="box box-bordered box-color">
        <div class="box-title">
            <h3  id="serialC">
                <i class="fa fa-th-list"></i>Agregar Activo</h3>
        </div>
        <div class="box-content nopadding" >
            ...
            <div class="row" id='row1'>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <?php
                            echo CHtml::dropDownList('Fccu[FCUU_Id]', 'Fccu[FCUU_Id]',
                                    CHtml::listData(Fcuu::model()->findAll(), 'FCUU_Id', 'FCUU_Descripcion'), 
                                    array('class' => 'select2-me','style'=>'width:100%' ,'prompt' => 'Seleccione una Categoria...',
                                'ajax' => array(
                                    'type' => 'POST',
            ...
            <div class="row hidden" id='row3' >
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <?php
                            echo CHtml::dropDownList('Fccu[FCCA]', 'Fccu[FCCA]', CHtml::listData(Fcca::model()->findAll(), 'FCCA_Id', 'FCCA_Descripcion'), array('class' => 'select2-me','style'=>'width:100%', 'id' => 'tipo',
                                'ajax' => array(
                                    'type' => 'POST',
            ...
            <div id="master" class='hidden'>
                <div class="col-sm-12" style="margin-top:10px; margin-bottom: 10px;">
                    ...
                    <?php echo CHtml::textField('Fccu[FCCU_Serial_Master]', '',
                            array('placeholder' => 'Codigo de Barras', 'class' => 'form-control add ', 
                                'id' => 'serial_master', 'size' => 45, 'maxlength' => 45)); ?>


                    <?php echo CHtml::label('Tipo,', 'Tipo.', array('class' => 'control-label add-label')); ?>
                    <?php
                    echo CHtml::dropDownList('Fccu[FCCA_Id_Master]', 'Fccu[FCCA_Id_Master]',
                            CHtml::listData(Fcca::model()->findAll(), 'FCCA_Id','FCCA_Descripcion'),
                             array('class' => 'select2-mve','style'=>'width:25.3% !important;background-color:blue;',
                        'ajax' => array(
                            'type' => 'POST',
            ...
            <div id="hall" class='hidden'>
                <div class="col-sm-12" style="margin-top:10px; margin-bottom: 10px;">
                    <?php echo CHtml::label('Serial', 'Serial', array('class' => 'control-label add-label ')); ?>
                    <?php echo CHtml::textField('Fccu[FCCU_Serial_Hall]', '', 
                         array('placeholder' => 'Serial/IMEI/SN', 'class' => 'form-control add-hall ', 
                        'id' => 'serial_hall', 'size' => 45, 'maxlength' => 45)
                        ); ?>

                    <?php echo CHtml::label('Numero', 'Numero', array('class' => 'control-label add-label ')); ?>
                    <?php
                    echo CHtml::textField('Fccu[FCCU_Numero]', '', array('placeholder' => 'Numero de telefono',
                    ...
                    <div class="input-group add-group">
                        <?php
                        echo CHtml::textField('Fccu[FCCU_MontoMin]', '', array('placeholder' => '0', 'id' => 'monto',
