    ...
    <div id='fondo'>
        <div id='wrap'>
            <div id="content2">
                ...
                <input name="submit" value="Actualizar" type="submit" onClick="document.location.href='./entradas.php?d='+document.getElementById('inputField').value+'&g='+document.getElementById('inputField2').value;" >


                <div class="form">

                    <article id="entrada"><img src="images/loading3.gif" width="120" height="120" style="margin-left: 45%;"></article>
